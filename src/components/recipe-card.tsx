...
import { MapPin, ChefHat, Leaf, Utensils } from 'lucide-react'; // Added Utensils for a fallback icon
...
const RecipeCard: React.FC<RecipeCardProps> = ({ recipe }) => {
  ...
  return (
    <Link href={`/recipe/${recipe.idMeal}`} passHref legacyBehavior>
      <a className="bg-card text-card-foreground rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 ease-in-out hover:shadow-2xl hover:scale-105 flex flex-col h-full group cursor-pointer">
